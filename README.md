...
- Failed submissions return clear inline errors for malformed links, non-public notebooks, invalid email addresses, missing legal confirmation, and descriptions longer than 75 words.
